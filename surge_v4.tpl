...
{% import './snippet/new_apple_rules.tpl' as apple_rules %}
{% import './snippet/proxy_rules.tpl' as proxy_rules %}
{% import './snippet/direct_and_domestic_rules.tpl' as direct_rules %}
...
☁️ Others = select, 🚀 Proxy, 🍂 Domestic

[Rule]
// my own rules
PROCESS-NAME,/Applications/Notion.app/Contents/MacOS/Notion,🚀 Proxy // Notion is on Proxy!

{{ apple_rules.main('🍎 Apple ') }}
{{ proxy_rules.main('🚀 Proxy') }}
{{ direct_rules.main('🍂 Domestic') }}
